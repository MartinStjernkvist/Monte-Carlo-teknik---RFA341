...
class växelverkan:
    ...
    def sigma_foto(self, energi):
        ...
        Z = 82  # räknar inte med Z-beroende, BYT TILL MEDELVÄRDE AV Z FÖR MÄNNISKOKROPP
        alpha = 1 / 137
        # return 16 / 3 * np.sqrt(2) * pi * r_e ** 2 * alpha ** 4 * Z ** 5 / energi ** 3.5
...
print(16 / 3 * np.sqrt(2) * pi * r_e ** 2 * (1/137) ** 4)
print(5 * 10**11)
print(4*10**(1))

print((1.602*10**(-19))**2/(m_e * c**2)*10**(14))
